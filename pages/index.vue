  ...
  <div class="projects-section">
    ...
    <div class="projects-section-line">
      ...
      <div class="view-actions">
        <button ref="listView" v-on:click="handlerListView" class="view-btn list-view" title="List View">
        ...
        <button ref="gridView" v-on:click="handlerGridView" class="view-btn grid-view active" title="Grid View">
    ...
    <div ref="projectsList" class="project-boxes jsGridView">
...
let gridView = ref(null)
let projectsList = ref(null)

function handlerGridView() {
  gridView.value.classList.add('active')
  listView.value.classList.remove('active')
  projectsList.value.classList.remove('jsListView')
  projectsList.value.classList.add('jsGridView')
}

function handlerListView() {
  gridView.value.classList.remove('active')
  listView.value.classList.add('active')
  projectsList.value.classList.remove('jsGridView')
  projectsList.value.classList.add('jsListView')
}
